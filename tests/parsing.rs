...
#[test]
fn get_exchange_status_response_deserializes_per_index_fields() {
    let json = r#"{
        "exchange_active": true,
        "trading_active": true,
    ...
    let statuses = resp
        .exchange_index_statuses
        .expect("exchange_index_statuses");
...
#[test]
fn get_api_keys_response_deserializes_restricted_subaccount() {
    let json = r#"{
        "api_keys": [{
            "api_key_id": "key-1",
            "name": "test key",
