...
#[tokio::test]
#[allow(deprecated)] // exercises the deprecated rfq_creator_user_id filter
...
async fn test_get_subaccount_netting() {
    ...
    match resp {
        ...
        Err(KalshiError::Http {
            ...
            // `service` was removed from all error responses on 2026-08-06; the
            // exchange no longer returns it, but the field is kept (deprecated)
