...
///
/// The legacy `/portfolio/orders` mutation endpoints (`create_order` et al.)
/// were deprecated 2026-06-18; new integrations should use the V2 endpoints
/// (`create_order_v2` and friends), as this example does.
use kalshi_fast::{
