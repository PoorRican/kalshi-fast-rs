...
pub enum WsChannelV2 {
    ...
    CfbenchmarksValue,
    /// CF Benchmarks 5Hz (up to 5 updates/sec) value feed for the subset of
    /// indices published at 200ms granularity. Added 2026-09-03.
    CfbenchmarksValue5Hz,
    /// Real-time Pyth price updates for configured underlying tickers.
    /// Requires authentication. Added 2026-07-23.
    PythValue,
}
