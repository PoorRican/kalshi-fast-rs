...
pub enum WsChannelV2 {
    ...
    CfbenchmarksValue,
    /// CF Benchmarks 5Hz (up to 5 updates/sec) reference index value feed.
    /// Sibling of [`WsChannelV2::CfbenchmarksValue`]; requires authentication.
    CfbenchmarksValue5Hz,
    /// Pyth reference price feed for configured underlying tickers. Requires
    /// authentication.
    PythValue,
}
