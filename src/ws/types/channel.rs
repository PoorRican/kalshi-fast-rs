...
pub enum WsChannelV2 {
    ...
    CfbenchmarksValue,
    /// CF Benchmarks 5Hz value feed (up to 5 updates/sec on 200ms-granularity
    /// indices). Added 2026-09-03.
    CfbenchmarksValue5hz,
    /// Deduplicated Pyth prices by underlying ticker. Added 2026-07-23.
    PythValue,
}
