...
pub enum WsMsgType {
    ...
    /// `cfbenchmarks_value_5hz` — sibling of [`WsMsgType::CfbenchmarksValue`] at up
    /// to 5 updates/sec.
    CfbenchmarksValue5Hz,
    CfbenchmarksValue5HzIndexlist,
    /// `pyth_value` — Pyth reference price update.
    PythValue,
    /// `pyth_value_underlying_list` — recently streamed Pyth underlying tickers.
