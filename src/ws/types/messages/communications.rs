...
pub struct WsQuoteCreated {
    ...
    pub created_ts: String,
    /// Present only when your side of this quote used a subaccount. Contains your own
    /// subaccount number; the counterparty's subaccount is never shared. Added 2026-07-30.
    #[serde(default)]
