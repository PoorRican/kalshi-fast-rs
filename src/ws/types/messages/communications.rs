...
pub struct WsQuoteCreated {
    ...
    pub created_ts: String,
    /// Subaccount the quote was placed under (recipient-scoped: quote
    /// creators see their own subaccount, RFQ creators see theirs). Absent
    /// when no subaccount was used. Added 2026-07-30.
    #[serde(default)]
...
pub struct WsQuoteAccepted {
    ...
    #[serde(default)]
    pub rfq_target_cost_dollars: Option<FixedPointDollars>,
    /// Subaccount the quote was placed under. Absent when no subaccount was
    /// used. Added 2026-07-30.
    #[serde(default)]
    pub subaccount: Option<u32>,
}
