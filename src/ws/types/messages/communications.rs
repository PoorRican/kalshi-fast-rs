...
mod tests {
    ...
    #[test]
    fn ws_quote_created_parses_subaccount_and_rfq_creator_id() {
        let json = r#"{
            "quote_id": "q1",
            "rfq_id": "r1",
            "quote_creator_id": "c1",
        ...
        assert_eq!(owned.rfq_creator_id.as_deref(), Some("rc1"));

        let borrowed: WsQuoteCreatedRef = serde_json::from_str(json).unwrap();
        let round_tripped = borrowed.into_owned();
        assert_eq!(round_tripped.subaccount, Some(3));
        assert_eq!(round_tripped.rfq_creator_id.as_deref(), Some("rc1"));
    }

    #[test]
    fn ws_quote_created_tolerates_missing_subaccount() {
        let json = r#"{
            "quote_id": "q1",
            "rfq_id": "r1",
            "quote_creator_id": "c1",
    ...
    #[test]
    fn ws_quote_accepted_parses_subaccount_and_rfq_creator_id() {
        let json = r#"{
            "quote_id": "q1",
            "rfq_id": "r1",
            "quote_creator_id": "c1",
        ...
        assert_eq!(owned.subaccount, Some(5));
        assert_eq!(owned.rfq_creator_id.as_deref(), Some("rc1"));
    }

    #[test]
    fn ws_quote_executed_parses_subaccount() {
        let json = r#"{
            "quote_id": "q1",
            "rfq_id": "r1",
            "quote_creator_id": "c1",
        ...
        assert_eq!(owned.subaccount, Some(7));
    }
}
