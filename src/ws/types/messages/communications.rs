...
pub struct WsQuoteCreated {
    ...
    pub created_ts: String,
    /// Subaccount your side of the quote used, when applicable. Quote
    /// creators see their own quote subaccount; RFQ creators see their own
    /// RFQ subaccount. Added 2026-07-30.
    #[serde(default)]
