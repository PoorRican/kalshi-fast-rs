...
pub struct WsMarketLifecycleV2 {
    ...
    /// Present only on `metadata_updated` events for custom/structured strike
    /// types. Added 2026-06-18.
    #[serde(default)]
...
pub struct WsEventLifecycle {
    ...
    /// Identifier for the exchange shard the event's markets live on. The
    /// spec marks this required; modeled `Option` defensively. Added 2026-07-30.
    #[serde(default)]
    pub exchange_index: Option<i64>,
    #[serde(default)]
    pub title: Option<String>,
