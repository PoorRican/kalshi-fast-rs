...
pub struct WsMarketLifecycleV2 {
    ...
    /// Valid price bands, emitted alongside `price_level_structure` on
    /// `created` and `price_level_structure_updated` events. Added 2026-07-02.
    #[serde(default)]
    ...
    /// on `metadata_updated` events for a custom/structured strike type. Added 2026-06-18.
    #[serde(default)]
