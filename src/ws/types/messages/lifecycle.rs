...
pub struct WsMarketLifecycleV2 {
    ...
    /// Determines how `floor_strike`/`cap_strike` are interpreted (`"between"`,
...
pub struct WsMarketLifecycleV2Ref<'a> {
    ...
    #[serde(default)]
    pub cap_strike: Option<f64>,
    /// Interpretation of floor/cap strike; present only on `metadata_updated` events. Added 2026-06-17.
    #[serde(default, borrow)]
