...
pub struct WsMarketLifecycleV2 {
    ...
    /// Top-level strike type for `metadata_updated` events (e.g. "between",
    /// "greater", "less"). Added 2026-06-18.
    #[serde(default)]
...
pub struct WsMarketLifecycleV2Ref<'a> {
    ...
    /// events; kept as owned `PriceRange`s since this field is low-frequency
    /// (not per-tick data). Added 2026-07-02.
    #[serde(default)]
    pub price_ranges: Option<Vec<PriceRange>>,
