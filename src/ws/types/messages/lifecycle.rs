...
mod tests {
    ...
    fn metadata_updated_surfaces_top_level_fields() {
        ...
        assert_eq!(owned.cap_strike, Some(95.5));
        ...
        assert_eq!(round_tripped.cap_strike, Some(95.5));
    ...
    /// events, describing the market's valid price bands in fixed-point dollars.
    #[test]
