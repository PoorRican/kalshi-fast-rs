...
/// A valid price band, in fixed-point dollars: `{ start, end, step }`.
...
pub struct WsMarketLifecycleV2 {
    ...
    /// Exchange shard this market lives on. Present only when the market is
    /// created. Added with exchange sharding (2026-07).
    #[serde(default)]
...
pub struct WsEventLifecycle {
    ...
    /// Exchange shard the event's markets live on. Added with exchange
    /// sharding (2026-07).
    #[serde(default)]
    pub exchange_index: Option<i64>,
    #[serde(default)]
