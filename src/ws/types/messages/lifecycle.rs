...
pub struct WsMarketLifecycleV2 {
    ...
    /// when the market is created (2026-07-30).
    #[serde(default)]
    ...
    /// only on `metadata_updated` events (2026-06-18).
    #[serde(default)]
...
mod tests {
    ...
    fn created_event_surfaces_exchange_index_and_price_ranges() {
        ...
        assert_eq!(round_tripped.price_ranges.unwrap()[0].step, "0.01");
    }
