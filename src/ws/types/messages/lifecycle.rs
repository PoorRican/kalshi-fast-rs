...
/// A valid order price band, in fixed-point dollars: `{ start, end, step }`.
...
pub struct WsMarketLifecycleV2 {
    ...
    /// Top-level updated strike type. Only present on `metadata_updated`
    /// events. Added 2026-06-18.
    #[serde(default)]
    pub strike_type: Option<String>,
    /// Top-level updated cap strike. Only present on `metadata_updated`
    /// events. Added 2026-06-18.
    #[serde(default)]
    pub cap_strike: Option<f64>,
    /// Top-level updated custom strike map. Only present on `metadata_updated`
...
pub struct WsMarketLifecycleV2Ref<'a> {
    ...
    #[serde(default)]
    pub cap_strike: Option<f64>,
    /// Top-level updated custom strike map; present only on `metadata_updated`
    /// events for custom/structured strike types. Added 2026-06-18.
    #[serde(default)]
    pub custom_strike: Option<BTreeMap<String, String>>,
