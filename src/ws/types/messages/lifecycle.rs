...
mod tests {
    ...
    /// `metadata_updated` also carries `strike_type`, `cap_strike`, and
    ...
    /// `created` events carry `exchange_index`; `price_level_structure_updated`
    /// events carry `price_ranges`. Added 2026-07-30 / 2026-07-02.
    #[test]
    ...
    /// `event_lifecycle` messages carry `exchange_index`. Added 2026-07-30.
    #[test]
