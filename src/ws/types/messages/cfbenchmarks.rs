...
/// (added 2026-09-03).
///
/// Lean raw ticks at up to five updates per second. Unlike
/// [`WsCfBenchmarksValue`] these carry no rolling averages — those stay on the
/// once-per-second `cfbenchmarks_value` channel.
#[derive(Debug, Clone, Deserialize)]
