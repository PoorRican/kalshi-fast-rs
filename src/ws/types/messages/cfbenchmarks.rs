...
///
/// Sibling of [`WsCfBenchmarksValue`] delivering up to 5 raw ticks/second
/// per index. Unlike the base channel, this is a lean raw tick with no
/// windowed-average fields.
#[derive(Debug, Clone, Deserialize)]
...
/// subscription. Lists the index IDs recently observed on the 5Hz stream
/// (not a full catalog).
#[derive(Debug, Clone, Deserialize)]
