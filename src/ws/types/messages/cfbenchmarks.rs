...
///
/// High-frequency sibling of `cfbenchmarks_value` (up to 5 updates/sec on the
/// subset of indices CF Benchmarks publishes at 200ms granularity). Lean raw
/// ticks only — no windowed averages. Added 2026-09-03.
#[derive(Debug, Clone, Deserialize)]
