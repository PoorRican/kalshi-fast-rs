...
mod tests {
    ...
    fn ws_pyth_value_deserializes() {
        ...
        assert_eq!(owned.underlying_ticker, "Crypto.BTC/USD");
        assert_eq!(owned.value_usd, "65000.12340000");
        ...
        assert_eq!(round_tripped.source_ts_ms, owned.source_ts_ms);
    }

    #[test]
    fn ws_pyth_underlying_list_deserializes() {
        let json = r#"{"underlying_tickers": ["Crypto.BTC/USD", "Crypto.ETH/USD"]}"#;
