...
mod tests {
    ...
    #[test]
    fn ws_pyth_value_parses_and_round_trips_borrowed() {
        let json = r#"{
        ...
        assert_eq!(owned.received_at, 1700000000123);
    ...
    #[test]
    fn ws_pyth_underlying_list_parses_and_round_trips_borrowed() {
        ...
        let round_tripped = borrowed.into_owned();
        assert_eq!(round_tripped.underlying_tickers, owned.underlying_tickers);
    }
}
