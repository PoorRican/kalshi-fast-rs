...
/// Message payload for the `pyth_value` WebSocket channel. Requires an
/// authenticated connection. Added 2026-07-23.
...
mod tests {
    ...
    #[test]
    fn pyth_value_deserializes_and_round_trips_owned() {
        let json = r#"{
        ...
        assert_eq!(owned.value_usd, "65000.12345678");
        assert_eq!(owned.source_ts_ms, 1700000000000);
        assert_eq!(owned.received_at, 1700000000050);
        ...
        assert_eq!(round_tripped.value_usd, "65000.12345678");
    }

    #[test]
    fn pyth_underlying_list_deserializes_and_round_trips_owned() {
