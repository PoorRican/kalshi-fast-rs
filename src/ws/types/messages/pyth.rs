...
/// Message payload for the `pyth_value` WebSocket channel. Added 2026-07-23.
...
mod tests {
    ...
    fn pyth_value_deserializes() {
        ...
        assert_eq!(owned.value_usd, "2350.12345678");
        ...
        assert_eq!(round_tripped.received_at, 1700000000050);
    }

    #[test]
    fn pyth_underlying_list_deserializes() {
