...
pub struct WsTrade {
    ...
    /// 2026-08-13. Spec marks this required; `#[serde(default)]` tolerates
    /// payloads predating the flag (defaults to `false`), matching the REST
    /// `Trade.is_block_trade` precedent.
    #[serde(default)]
