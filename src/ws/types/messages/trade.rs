...
pub struct WsTrade {
    ...
    /// 2026-08-13; `#[serde(default)]` so payloads predating the flag parse
    /// as `false`, mirroring the REST `Trade::is_block_trade` field.
    #[serde(default)]
...
mod tests {
    ...
    #[test]
    fn is_block_trade_parses_when_present() {
        let json = r#"{
            "trade_id": "t-1",
            "market_ticker": "MKT-1",
            "count_fp": "10.00",
