...
pub struct WsTrade {
    ...
    /// 2026-08-13; the AsyncAPI marks it required, but `#[serde(default)]`
    /// keeps payloads that predate the flag parseable (matching the REST
    /// `Trade` treatment).
    #[serde(default)]
...
mod tests {
    ...
    #[test]
    fn ws_trade_block_trade_defaults_false_when_absent() {
        let json = r#"{
            "trade_id":"t1",
            "market_ticker":"TST",
            "count_fp":"2.00",
