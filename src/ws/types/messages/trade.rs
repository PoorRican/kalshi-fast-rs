...
pub struct WsTrade {
    ...
    /// Whether the trade was matched off book. Added 2026-08-13. Marked
    /// required by the AsyncAPI but modeled as `Option` for defensive parsing,
    /// consistent with the other nominally-required fields on this message.
    #[serde(default)]
