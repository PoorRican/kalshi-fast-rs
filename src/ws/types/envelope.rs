...
pub enum WsDataMessageV2 {
    ...
    CfbenchmarksValue5hzIndexlist {
        sid: Option<u64>,
        seq: Option<u64>,
        msg: WsCfBenchmarksValue5HzIndexList,
    },
    PythValue {
        sid: Option<u64>,
        seq: Option<u64>,
...
pub enum WsDataMessageRef<'a> {
    ...
    CfbenchmarksValue5hzIndexlist {
        sid: Option<u64>,
        seq: Option<u64>,
        msg: WsCfBenchmarksValue5HzIndexListRef<'a>,
    },
    PythValue {
        sid: Option<u64>,
        seq: Option<u64>,
...
mod tests {
    ...
    fn ws_envelope_into_message_pyth_value() {
        ...
        match env.into_message().unwrap() {
            WsMessageV2::Data(WsDataMessageV2::PythValue { sid, seq, msg }) => {
                ...
                assert_eq!(msg.value_usd, "3400.12340000");
            }
    ...
    #[test]
    fn ws_envelope_into_message_pyth_underlying_list() {
        let json = r#"{
