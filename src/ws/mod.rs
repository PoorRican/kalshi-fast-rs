...
//! | [`WsChannelV2::CfbenchmarksValue`] | Yes | CF Benchmarks index values, ~1 update/sec |
//! | [`WsChannelV2::CfbenchmarksValue5hz`] | Yes | CF Benchmarks index values, up to 5 updates/sec (smaller coin set) |
//! | [`WsChannelV2::PythValue`] | Yes | Deduplicated real-time Pyth prices by underlying ticker |
//!
