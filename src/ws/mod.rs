...
//! | [`WsChannelV2::CfbenchmarksValue`] | Yes | CF Benchmarks index values (1/sec) |
//! | [`WsChannelV2::CfbenchmarksValue5hz`] | Yes | CF Benchmarks index values (up to 5/sec) |
...
//! error, so it is no longer modeled here. Use
//! [`WsChannelV2::MultivariateMarketLifecycle`] for multivariate market state
//! changes.
//!
