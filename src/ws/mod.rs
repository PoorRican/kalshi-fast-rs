...
//! | [`WsChannelV2::CfbenchmarksValue`] | No | CF Benchmarks index values (1/sec) |
//! | [`WsChannelV2::CfbenchmarksValue5hz`] | No | CF Benchmarks index values (up to 5/sec) |
//! | [`WsChannelV2::PythValue`] | Yes | Deduplicated Pyth price updates |
//!
//! The `multivariate` channel (message type `multivariate_lookup`) was removed
//! by Kalshi on 2026-08-06; use [`WsChannelV2::MultivariateMarketLifecycle`]
