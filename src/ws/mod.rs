...
//! | [`WsChannelV2::CfbenchmarksValue`] | No | CF Benchmarks reference index values (~1/sec) |
//! | [`WsChannelV2::CfbenchmarksValue5Hz`] | No | CF Benchmarks index values (up to 5/sec, subset of indices) |
//! | [`WsChannelV2::PythValue`] | Yes | Real-time Pyth prices for configured underlyings |
//!
