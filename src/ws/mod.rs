...
//! | [`WsChannelV2::CfbenchmarksValue`] | Yes | CF Benchmarks index value feed |
//! | [`WsChannelV2::PythValue`] | Yes | Pyth price feed for configured underlying tickers |
//!
//! The legacy `multivariate` channel (`WsChannelV2::Multivariate`,
//! message type `multivariate_lookup`) was removed by Kalshi on 2026-08-06;
//! subscribing to it now returns an unknown-channel error, so it has been
//! removed from this crate. Use `MultivariateMarketLifecycle` for
