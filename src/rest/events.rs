...
pub struct GetEventsParams {
    ...
    /// Filter events with metadata updated after this Unix timestamp (seconds). Added to OpenAPI 3.21.0.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_updated_ts: Option<i64>,
    /// Filter by comma-separated event tickers. Added 2026-06-12 (OpenAPI 3.21.0).
    #[serde(
...
pub struct EventData {
    ...
    /// Settlement sources for this event. Added to EventData required list 2026-06-18 (OpenAPI 3.21.0).
    /// The field is required-but-nullable in the spec; null is treated as an empty list.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
    pub settlement_sources: Vec<SettlementSource>,
    /// Fee type override for this event (takes precedence over series-level fee when present).
    #[serde(default)]
