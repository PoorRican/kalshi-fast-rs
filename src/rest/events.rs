...
pub struct GetEventsParams {
    ...
    /// Return events with metadata updated after this Unix timestamp (seconds).
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EventData {
    ...
    /// Official sources used to determine markets within this event. Added 2026-06-18.
    /// Marked `required` + `nullable` in the OpenAPI; `None` when the server sends `null`.
    #[serde(default)]
