...
pub struct GetEventsParams {
    ...
    /// Restrict results to a comma-separated list of event tickers. Added 2026-06-18.
    #[serde(
...
pub struct EventData {
    ...
    /// Identifier for the exchange shard new markets in this event live on. Added 2026-07-30.
    #[serde(default)]
    pub exchange_index: Option<i64>,
    /// Fee type override for this event's markets, taking precedence over the series-level fee.
    #[serde(default)]
