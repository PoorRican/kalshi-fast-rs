...
pub struct GetEventsParams {
    ...
    /// Filter to events whose metadata was updated after this Unix
    /// timestamp (seconds). Useful for efficiently polling for changes.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EventData {
    ...
    /// Official sources used to determine the event's markets, mirroring
