...
pub struct EventData {
    ...
    /// Mirrors `Series.settlement_sources`. Added 2026-06-18.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
    pub settlement_sources: Vec<SettlementSource>,
    /// Exchange index identifying the exchange shard the event's markets live
    /// on. Added 2026-07-30 (not part of the changelog entries reconciled by
    /// this refresh; discovered while touching this struct's OpenAPI schema).
    #[serde(default)]
