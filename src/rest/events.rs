...
pub struct GetEventsParams {
    ...
    /// Filter by event tickers, as a comma-separated list. Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tickers: Option<String>,
    /// Filter events with metadata updated after this Unix timestamp
    /// (seconds). Use to efficiently poll for changes.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EventData {
    ...
    /// Official sources used to determine the event's markets. Mirrors the
    /// field already present on `Series`. Added 2026-06-18.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
