...
pub struct EventData {
    ...
    #[serde(default)]
    pub category: Option<String>,
    /// Deprecated 2026-08-27. No longer populated; always returns `false`. Will be
    ...
    /// Official sources used for market determination within this event, mirroring
    /// the field already available on series. Added 2026-06-18.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
    pub settlement_sources: Vec<SettlementSource>,
    /// Exchange shard this event's markets live on.
    #[serde(default)]
