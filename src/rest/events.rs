...
pub struct GetEventsParams {
    ...
    /// Filter by specific event tickers. Added 2026-06-18.
    #[serde(
        skip_serializing_if = "Option::is_none",
        serialize_with = "serialize_csv_opt"
    )]
    pub tickers: Option<Vec<String>>,
    /// Filter events with metadata updated after this Unix timestamp (seconds). Use to
    /// efficiently poll for changes.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EventData {
    ...
    /// Official sources used to determine this event's markets, mirroring the field already
    /// available on series. Added 2026-06-18.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
