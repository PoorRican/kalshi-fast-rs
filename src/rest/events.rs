...
pub struct GetEventsParams {
    ...
    /// Filter by event tickers (comma-separated, max 10). Added 2026-06-12.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tickers: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_close_ts: Option<i64>, // seconds since epoch
    /// Filter events with metadata updated after this Unix timestamp (seconds). Added 2026-06-12.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EventData {
    ...
    /// Official settlement sources for markets in this event. Added to spec 2026-06-18.
    /// Nullable in the OpenAPI schema; modeled as `Option` so pre-addition payloads still parse.
    #[serde(default)]
