...
pub struct GetEventsParams {
    ...
    /// Restrict the response to these event tickers (comma-separated upstream).
    /// Added 2026-06-18.
    #[serde(
...
pub struct EventData {
    ...
    /// Official sources used to determine this event's markets, mirroring the
    /// series-level field. Added 2026-06-18.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
    pub settlement_sources: Vec<SettlementSource>,
    /// Exchange shard this event's markets live on. Added 2026-07-30.
    #[serde(default)]
    pub exchange_index: Option<i32>,
    /// Fee type override for this event; takes precedence over the series fee.
    #[serde(default)]
