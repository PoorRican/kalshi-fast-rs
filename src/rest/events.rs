...
pub struct GetEventsParams {
    ...
    /// seconds). Use this to efficiently poll for changes. Added 2026-07.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct EventData {
    ...
    /// Exchange shard this event is on. Defaults to `0` if unspecified.
    /// Added 2026-06 (multi-exchange-index rollout).
    #[serde(default)]
