...
pub struct EventMetadata {
    ...
    /// documented in the Kalshi changelog but not yet in the published
    /// OpenAPI spec, so kept as a raw string.
    #[serde(default)]
...
pub struct Series {
    ...
    /// Target exchange instance for new events under this series. Added 2026-07-30.
    #[serde(default)]
