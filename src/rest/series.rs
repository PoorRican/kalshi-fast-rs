...
pub struct EventMetadata {
    ...
    /// Cadence of the event/series (e.g. "daily", "weekly"), when set. Added
    /// 2026-07-30. This field lives on `product_metadata`, which the OpenAPI
    /// spec documents only as an opaque `object` — see `docs/spec-parity.md`.
    #[serde(default)]
...
pub struct Series {
    ...
    /// Exchange index this series' markets trade on. Added 2026-07-30.
    #[serde(default)]
