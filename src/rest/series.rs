...
pub struct EventMetadata {
    ...
    /// How often the event recurs (e.g. `"fifteen_min"`), when the event has
    /// a cadence set. Added 2026-07-30.
    #[serde(default)]
...
pub struct Series {
    ...
    /// Exchange index identifying the target exchange instance for new
    /// events. Added 2026-07-30.
    #[serde(default)]
