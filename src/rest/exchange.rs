...
/// Per-exchange-index status breakdown (`exchange_index_statuses` on
/// [`GetExchangeStatusResponse`]). Added 2026-06-26.
...
pub struct GetExchangeStatusResponse {
    ...
    /// Per-index status breakdown; absent when unavailable. Added 2026-06-26.
    #[serde(default)]
