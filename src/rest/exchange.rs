...
/// Per-exchange-index status breakdown entry on [`GetExchangeStatusResponse`].
///
/// Added 2026-07-02 (`exchange_index_statuses`); `description` was added
/// 2026-08-13. All fields are marked required in the OpenAPI schema.
