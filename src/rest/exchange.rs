...
pub struct GetExchangeStatusResponse {
    ...
    /// top-level fields above reflect the default exchange index (0). Added
    /// 2026-07-02, `description` added 2026-08-13.
    #[serde(default, deserialize_with = "deserialize_null_as_empty_vec")]
    pub exchange_index_statuses: Vec<ExchangeIndexStatus>,
}

/// Status breakdown for a single exchange shard. Added 2026-07-02.
#[derive(Debug, Clone, Deserialize, Serialize)]
