...
//! 2026-07-04; use [`KalshiRestClient::get_exchange_schedule`] for exchange
//! hours instead.
...
/// Per-exchange-index breakdown of `GET /exchange/status`. Added 2026-07-02
/// (`intra_exchange_transfers_active`, `exchange_index_statuses`) and
/// 2026-08-13 (`description`).
...
pub struct GetExchangeStatusResponse {
    ...
    /// True if intra-exchange transfers are currently permitted (default
    /// exchange index). Added 2026-07-02.
    #[serde(default)]
    pub intra_exchange_transfers_active: Option<bool>,
    /// Per-exchange-index breakdown; the top-level fields above reflect the
    /// default exchange index (0). Absent when unavailable. Added 2026-07-02.
    #[serde(default)]
