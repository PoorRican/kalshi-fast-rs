...
//!
//! `GET /exchange/announcements` was removed from the Predictions REST API
//! (2026-07-04) and is no longer modeled here.
...
pub struct GetExchangeStatusResponse {
    ...
    /// True if intra-exchange transfers are currently permitted. Added 2026-07.
    #[serde(default)]
    ...
    /// Added 2026-07 (per-index exchange status).
    #[serde(default)]
