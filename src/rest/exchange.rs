...
//! changes useful for cache invalidation. `GET /exchange/announcements` was
//! removed by Kalshi on 2026-07-04; use `GET /exchange/schedule` instead.
...
/// Per-exchange-index breakdown of exchange status.
///
/// The top-level fields on [`GetExchangeStatusResponse`] reflect the default
/// exchange index (0); this struct carries the same shape per shard. Added
/// 2026-07-02 (`intra_exchange_transfers_active`, `exchange_index_statuses`)
/// and 2026-08-13 (`description`).
