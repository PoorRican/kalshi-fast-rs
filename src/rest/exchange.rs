...
/// Per-exchange-shard operational status. Added 2026-07-02 (as a per-index
/// breakdown on [`GetExchangeStatusResponse`]); `description` added 2026-08-13.
...
pub struct GetExchangeStatusResponse {
    ...
    /// breakdown is unavailable. Added 2026-07-02.
    #[serde(default)]
