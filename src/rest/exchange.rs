...
//! trading is active, per-shard status, standard and maintenance hours, and
//! timestamps/fee changes useful for cache invalidation.
//!
//! `GET /exchange/announcements` was removed upstream on 2026-07-04; use
//! [`KalshiRestClient::get_exchange_schedule`] for maintenance windows.
...
/// Operational status of one exchange shard. Added 2026-07-02; `description`
/// added 2026-08-13.
...
pub struct GetExchangeStatusResponse {
    ...
    /// Per-exchange-index breakdown. Added 2026-07-02. The top-level fields
    /// above reflect the default exchange index (0). Empty when the per-index
