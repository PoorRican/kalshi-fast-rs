...
/// Status of a single exchange index (shard). The top-level fields on
/// [`GetExchangeStatusResponse`] reflect the default exchange index (0).
/// Added 2026-06-26.
...
pub struct GetExchangeStatusResponse {
    ...
    /// Per-exchange-index breakdown. Absent when unavailable. Added
    /// 2026-06-26.
    #[serde(default)]
