...
pub struct Order {
    ...
    /// Exchange shard index the order lives on. Added 2026-06.
    #[serde(default)]
...
pub struct OrderGroup {
    ...
    /// Exchange shard index the order group lives on. Added 2026-06.
    #[serde(default)]
    pub exchange_index: Option<u32>,
    #[serde(default, flatten)]
    pub extra: Map<String, Value>,
...
pub struct CreateOrderGroupRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub contracts_limit_fp: Option<FixedPointCount>,
    /// Exchange shard index to create the order group on. Defaults to 0. Added 2026-06.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub exchange_index: Option<u32>,
}
...
pub struct CreateOrderGroupResponse {
    ...
    #[serde(default)]
    pub subaccount: Option<u32>,
    /// Exchange shard index the order group was created on. Added 2026-06.
    #[serde(default)]
    pub exchange_index: Option<u32>,
}
...
/// Query params for [`KalshiRestClient::update_order_group_limit`]. Added 2026-08-06.
#[derive(Debug, Clone, Default, Serialize)]
...
pub struct CreateOrderV2Request {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub order_group_id: Option<String>,
    /// Exchange shard index. Defaults to 0. Use -1 to auto-route by `ticker`.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CancelOrderV2Params {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub exchange_index: Option<i32>,
    /// Market ticker; required when `exchange_index` is -1 (auto). Added 2026-06.
    #[serde(skip_serializing_if = "Option::is_none")]
