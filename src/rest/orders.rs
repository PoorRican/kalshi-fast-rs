...
impl KalshiRestClient {
    ...
    /// **Requires auth.**
    #[deprecated(
        note = "Legacy /portfolio/orders mutation endpoints are deprecated (2026-06-18); use create_order_v2 instead"
    )]
    ...
    /// **Requires auth.**
    #[deprecated(
        note = "Legacy /portfolio/orders mutation endpoints are deprecated (2026-06-18); use cancel_order_v2 instead"
    )]
    ...
    #[deprecated(
        note = "Legacy /portfolio/orders mutation endpoints are deprecated (2026-06-18); use amend_order_v2 instead"
    )]
    ...
    #[deprecated(
        note = "Legacy /portfolio/orders mutation endpoints are deprecated (2026-06-18); use decrease_order_v2 instead"
    )]
    ...
    #[deprecated(
        note = "Legacy /portfolio/orders mutation endpoints are deprecated (2026-06-18); use batch_create_orders_v2 instead"
    )]
    ...
    #[deprecated(
        note = "Legacy /portfolio/orders mutation endpoints are deprecated (2026-06-18); use batch_cancel_orders_v2 instead"
    )]
