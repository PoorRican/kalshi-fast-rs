...
//!
//! Order mutation (create/amend/decrease/cancel, batch create/cancel) is only available via
//! the V2 event-order endpoints (`create_order_v2`, `cancel_order_v2`, `amend_order_v2`,
//! `decrease_order_v2`, `batch_create_orders_v2`, `batch_cancel_orders_v2`) below — the legacy
//! non-V2 mutation endpoints (`POST /portfolio/orders`, `DELETE /portfolio/orders/{order_id}`,
//! `/amend`, `/decrease`, `/portfolio/orders/batched`) have been removed from the live API.
//!
