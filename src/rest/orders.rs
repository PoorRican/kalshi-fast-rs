...
pub struct Order {
    ...
    /// Identifier for the exchange shard this order resides on.
    #[serde(default)]
    pub exchange_index: Option<i64>,
}
...
pub struct UpdateOrderGroupLimitRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub contracts_limit_fp: Option<FixedPointCount>,
    /// Restricts the limit update to a specific subaccount. Added 2026-08-06.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subaccount: Option<u32>,
}
...
impl KalshiRestClient {
    ...
    /// subaccount; if provided, only that subaccount's orders are eligible.
    ...
    pub async fn cancel_all_orders_v2(
        ...
        let path = Self::full_path("/portfolio/events/orders");
        let params = crate::rest::SubaccountQueryParams { subaccount };
        self.send(
            Method::DELETE,
            &path,
            Some(&params),
