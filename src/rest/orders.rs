...
pub struct GetFcmOrdersParams {
    ...
    /// Comma-separated client order IDs (max 100). Required unless `subtrader_id`
    /// is supplied. Only orders created within the last 24 hours are searched.
    /// Added 2026-09-03.
    #[serde(
        skip_serializing_if = "Option::is_none",
        serialize_with = "serialize_csv_opt"
...
impl KalshiRestClient {
    ...
    /// (defaults to the primary account). Added 2026-08-06.
