...
/// Event-keyed live data (e.g. crypto price charts, commodity timeseries,
...
/// One point in a `GetWeatherIndexResponse` timeseries. Added 2026-08-20.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
impl KalshiRestClient {
    ...
    /// response's `live_data.type` names the schema of `live_data.details`.
    /// Added 2026-07-30.
    ...
    /// minute-resolution series behind hourly temperature markets. Values
    /// are Fahrenheit rounded to 0.01. Added 2026-08-20.
