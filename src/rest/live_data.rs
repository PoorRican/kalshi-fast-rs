...
pub struct EventLiveData {
    ...
    /// historical snapshot. Present for crypto live data.
    #[serde(default)]
...
impl KalshiRestClient {
    ...
    /// commodity price timeseries, weather observations, etc. The `type`
    /// field on the response names the schema of `details`. Added
    /// 2026-07-30.
