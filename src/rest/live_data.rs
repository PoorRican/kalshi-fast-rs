...
/// weather observations, etc. Added 2026-07-30.
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct EventLiveData {
    /// Type of live data. Names the schema of `details`.
    #[serde(rename = "type")]
    pub live_data_type: String,
    /// Live data details as a flexible object whose shape depends on `type`.
    #[serde(default)]
    pub details: Map<String, Value>,
...
impl KalshiRestClient {
    ...
    /// commodity price timeseries, weather observations, etc. (added
    /// 2026-07-30).
