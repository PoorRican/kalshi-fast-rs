...
pub struct GetHistoricalPositionsParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub event_ticker: Option<String>,
    /// 0 for primary, 1-63 for subaccounts. Defaults to 0. Added 2026-09-03.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    ///
    /// Positions whose markets settled before `market_positions_last_updated_ts` (see
    /// [`KalshiRestClient::get_historical_cutoff`]) live here rather than in `GET /portfolio/positions`.
