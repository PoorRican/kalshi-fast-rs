...
//! archived fills, orders, markets, positions, and the data-cutoff timestamps
...
pub struct GetHistoricalCutoffResponse {
    ...
    /// from the live data set before this timestamp are served via
...
impl KalshiRestClient {
    ...
    /// are archived per whole event and are never split between this
