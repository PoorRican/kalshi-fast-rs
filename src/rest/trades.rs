...
pub struct GetHistoricalCutoffResponse {
    ...
    /// `GET /historical/positions`. Added 2026-07-22.
    #[serde(default)]
...
impl KalshiRestClient {
    ...
    /// older than `market_positions_last_updated_ts` (see
    /// [`GetHistoricalCutoffResponse`]) are only available here; unsettled
    /// positions are always available via `GET /portfolio/positions`. Added 2026-07-22.
    ///
    /// **Requires auth.**
