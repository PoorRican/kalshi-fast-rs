...
pub struct GetHistoricalCutoffResponse {
    ...
    /// Positions whose settled markets were archived before this timestamp are
    /// available only via `GET /historical/positions`. Added 2026-07-23.
    #[serde(default)]
...
impl KalshiRestClient {
    ...
    /// List settled positions archived to the historical database, for events
    /// older than `market_positions_last_updated_ts` (see [`Self::get_historical_cutoff`]).
    /// Added 2026-07-23.
    ///
    /// **Requires auth.**
