...
impl KalshiRestClient {
    ...
    /// List settled positions archived to the historical database, for
    /// markets settled before `market_positions_last_updated_ts` on
    /// [`Self::get_historical_cutoff`]. Positions are archived per whole
    /// event and never split between this endpoint and
    /// [`Self::get_positions`]. Added 2026-07-23.
    ///
    /// **Requires auth.**
