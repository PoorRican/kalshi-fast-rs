...
pub struct GetHistoricalCutoffResponse {
    ...
    /// Settled positions archived before this timestamp must be accessed
    /// via `GET /historical/positions`. Added 2026-07-23.
    #[serde(default)]
...
impl KalshiRestClient {
    ...
    /// are archived per whole event; unsettled positions are always
