...
/// Per-exchange-index balance entry. Added 2026-08-20.
...
pub struct GetBalanceParams {
    /// 0 for primary, 1-63 for subaccounts.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subaccount: Option<u32>,
    /// Scopes `balance` / `portfolio_value` to one exchange index. Omit to
...
pub struct MarketPosition {
    pub ticker: String,
    /// Exchange shard this market belongs to. Added 2026-08-13.
    #[serde(default)]
    pub exchange_index: Option<u32>,
