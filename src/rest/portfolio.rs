...
/// A balance broken down by exchange shard, e.g. on
...
pub struct GetBalanceParams {
    /// 0 = primary, 1-63 = subaccount. Defaults to the primary account.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subaccount: Option<u32>,
    /// Scopes `balance` and `portfolio_value` to one exchange shard. Omit to
    /// include all exchange indexes. Added 2026-08-13 / 2026-08-20.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GetBalanceResponse {
    ...
    /// API keys. Added 2026-07-02 / 2026-08-13.
...
pub struct MarketPosition {
    pub ticker: String,
    /// Identifier for the exchange shard this position lives on. Added 2026-08-20.
    #[serde(default)]
    pub exchange_index: Option<i32>,
...
impl KalshiRestClient {
    /// Get the account balance. Pass `subaccount` and/or `exchange_index` to
    /// scope the result; omit both for the primary account's balance across
