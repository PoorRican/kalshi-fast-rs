...
/// Per-exchange-index balance breakdown entry.
...
pub struct GetBalanceParams {
    /// 0..=32. Defaults to the primary account.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub subaccount: Option<u32>,
    /// Scopes `balance`/`portfolio_value` to one exchange index. Omit for the
    /// aggregate across all exchange indexes. Added 2026-08-13/2026-08-20.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct MarketPosition {
    ...
    /// Identifier for the exchange shard this position lives on. Added as
    /// part of exchange sharding (2026-07/08).
    #[serde(default)]
    pub exchange_index: Option<i64>,
...
pub struct Settlement {
    ...
    /// as part of exchange sharding (2026-07/08).
    #[serde(default)]
    pub exchange_index: Option<i64>,
    pub event_ticker: String,
...
pub struct Fill {
    pub fill_id: String,
    /// Identifier for the exchange shard this fill occurred on. Added as
    /// part of exchange sharding (2026-07/08).
    #[serde(default)]
    pub exchange_index: Option<i64>,
    pub order_id: String,
