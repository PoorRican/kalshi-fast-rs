...
pub struct CreateRFQRequest {
    ...
    /// cost. Only valid together with a target cost. Added 2026-09-10.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    /// Get a quote scoped to its RFQ. Prefer this over [`Self::get_quote`]: the
    /// quote-ID-only lookup is deprecated. Added 2026-06-25.
    ...
    /// the quote-ID-only endpoint is deprecated. Added 2026-06-25.
    ...
    /// Confirm a quote scoped to its RFQ. Rate limits are more favorable than
    /// [`Self::confirm_quote`], and the quote-ID-only endpoint is deprecated.
    /// Added 2026-06-25.
