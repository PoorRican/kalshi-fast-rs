...
pub struct Quote {
    ...
    /// Whether the quote creator's order is post-only. Visible when the caller is
    /// the quote creator.
    #[serde(default)]
    ...
    /// Subaccount number of the RFQ creator. Visible when the caller is the RFQ
    /// creator.
    #[serde(default)]
...
impl KalshiRestClient {
    ...
    /// [`get_rfq_quote`](Self::get_rfq_quote) instead. Quotes are no longer
    /// guaranteed to remain queryable by ID alone.
    ...
    /// **Deprecated** (2026-06-25): use
    /// [`delete_rfq_quote`](Self::delete_rfq_quote) instead.
    ...
    /// **Deprecated** (2026-06-25): use
    /// [`accept_rfq_quote`](Self::accept_rfq_quote) instead.
    ...
    /// **Deprecated** (2026-06-25): use
    /// [`confirm_rfq_quote`](Self::confirm_rfq_quote) instead.
    ...
    /// Get a quote scoped to its RFQ. Added 2026-06-25; preferred over
    ...
    /// Delete a quote scoped to its RFQ. Added 2026-06-25; preferred over
    /// [`delete_quote`](Self::delete_quote).
    ...
    /// Accept a quote scoped to its RFQ. Added 2026-06-25; preferred over
    /// [`accept_quote`](Self::accept_quote).
    ...
    /// Confirm a quote scoped to its RFQ. Added 2026-06-25; preferred over
    /// [`confirm_quote`](Self::confirm_quote).
