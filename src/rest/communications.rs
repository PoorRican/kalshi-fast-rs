...
impl KalshiRestClient {
    ...
    /// Get a quote scoped to its RFQ. Added 2026-07-07 (RFQ-scoped quote
    /// lookup); supersedes the deprecated quote-ID-only [`Self::get_quote`].
    ...
    /// Delete a quote scoped to its RFQ; supersedes the deprecated
    ...
    /// Accept a quote scoped to its RFQ; supersedes the deprecated
    ...
    /// Confirm a quote scoped to its RFQ; supersedes the deprecated
