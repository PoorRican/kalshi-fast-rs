...
pub struct GetQuotesParams {
    ...
    /// Restricts the response to quotes last updated after this Unix timestamp. Added
    /// 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Restricts the response to quotes last updated before this Unix timestamp. Added
    /// 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// Deprecated upstream (still accepted): filter quotes by quote creator user ID.
    #[deprecated(since = "0.7.0", note = "deprecated upstream; use user_filter instead")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quote_creator_user_id: Option<String>,
    /// Deprecated upstream (still accepted): filter quotes by RFQ creator user ID.
    #[deprecated(
        since = "0.7.0",
        note = "deprecated upstream; use rfq_user_filter instead"
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rfq_creator_user_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GetRFQsParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    /// Deprecated upstream (still accepted): filter RFQs by creator user ID.
    #[deprecated(since = "0.7.0", note = "deprecated upstream; use user_filter instead")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub creator_user_id: Option<String>,
...
impl KalshiRestClient {
    ...
    /// Deprecated upstream: use [`Self::get_rfq_quote`] instead.
    #[deprecated(since = "0.7.0", note = "use get_rfq_quote instead")]
    ...
    /// Deprecated upstream: use [`Self::delete_rfq_quote`] instead.
    #[deprecated(since = "0.7.0", note = "use delete_rfq_quote instead")]
    ...
    /// Deprecated upstream: use [`Self::accept_rfq_quote`] instead.
    #[deprecated(since = "0.7.0", note = "use accept_rfq_quote instead")]
    ...
    /// Deprecated upstream: use [`Self::confirm_rfq_quote`] instead.
    #[deprecated(since = "0.7.0", note = "use confirm_rfq_quote instead")]
    ...
    /// Get a quote scoped to its RFQ. The quote must belong to the requested RFQ, or the
    /// endpoint returns 404. Added 2026-07-09.
    ...
    /// Delete a quote scoped to its RFQ, so it can no longer be accepted. Added 2026-06-25.
    ...
    /// Accept a quote scoped to its RFQ. Requires the quoter to confirm. Added 2026-06-25.
    ...
    /// Confirm a quote scoped to its RFQ. Starts a timer for order execution. Added 2026-06-25.
