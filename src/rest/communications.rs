...
impl KalshiRestClient {
    ...
    /// Get a quote scoped to its RFQ. Added 2026-07-09.
    ...
    /// Delete a quote scoped to its RFQ (it can no longer be accepted). Added 2026-07-09.
    ...
    /// Accept a quote scoped to its RFQ (requires the quoter to confirm). Added 2026-07-09.
    ...
    /// Confirm a quote scoped to its RFQ (starts the order-execution timer). Added 2026-07-09.
