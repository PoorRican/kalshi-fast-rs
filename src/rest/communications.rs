...
pub struct GetQuotesParams {
    ...
    /// Filter quotes last updated after this Unix timestamp (seconds).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Filter quotes last updated before this Unix timestamp (seconds).
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GetRFQsParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub creator_user_id: Option<String>,
    /// Filter for RFQs created by the authenticated user. Pass `"self"` to enable.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user_filter: Option<String>,
}
...
impl KalshiRestClient {
    ...
    /// Delete a quote scoped to its RFQ (`DELETE /communications/rfqs/{rfq_id}/quotes/{quote_id}`).
    ///
    /// RFQ-scoped variant of [`delete_quote`](Self::delete_quote). Added 2026-06-25.
    ...
    /// Accept a quote scoped to its RFQ (`PUT /communications/rfqs/{rfq_id}/quotes/{quote_id}/accept`).
    ///
    /// RFQ-scoped variant of [`accept_quote`](Self::accept_quote). Added 2026-06-25.
    ...
    /// Confirm a quote scoped to its RFQ (`PUT /communications/rfqs/{rfq_id}/quotes/{quote_id}/confirm`).
    ///
    /// RFQ-scoped variant of [`confirm_quote`](Self::confirm_quote). Added 2026-06-25.
