...
impl KalshiRestClient {
    ...
    /// RFQ-scoped variant of [`Self::delete_quote`]. Prefer this over the
    /// quote-ID-only endpoint: Kalshi expects `rfq_id` to become required for
    /// quote actions in a future migration.
    ...
    /// RFQ-scoped variant of [`Self::accept_quote`]. Prefer this over the
    /// quote-ID-only endpoint: Kalshi expects `rfq_id` to become required for
    /// quote actions in a future migration.
    ...
    /// RFQ-scoped variant of [`Self::confirm_quote`]. Prefer this over the
    /// quote-ID-only endpoint: Kalshi expects `rfq_id` to become required for
    /// quote actions in a future migration.
