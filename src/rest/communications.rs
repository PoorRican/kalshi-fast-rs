...
pub struct GetQuotesParams {
    ...
    /// No longer honored by the server as of 2026-06-20; quotes can only be
    /// filtered by user, RFQ, status, or update time. Kept for source
    /// compatibility but has no effect.
    #[deprecated(
        note = "server no longer filters GET /communications/quotes by event_ticker (2026-06-20)"
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// compatibility but has no effect.
    #[deprecated(
        note = "server no longer filters GET /communications/quotes by market_ticker (2026-06-20)"
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// Restricts the response to quotes last updated after this Unix
    /// timestamp (seconds). Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Restricts the response to quotes last updated before this Unix
    /// timestamp (seconds). Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub max_ts: Option<i64>,
    #[deprecated(note = "use `user_filter` or `rfq_user_filter` instead")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct GetRFQsParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    #[deprecated(note = "use `user_filter` instead")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub creator_user_id: Option<String>,
    /// Filter to RFQs created by the authenticated user. Pass `"self"` to
    /// enable. Added 2026-06.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user_filter: Option<String>,
}
...
impl KalshiRestClient {
    ...
    #[deprecated(
        note = "use `get_rfq_quote` (GET /communications/rfqs/{rfq_id}/quotes/{quote_id}) instead"
    )]
    ...
    #[deprecated(
        note = "use `delete_rfq_quote` (DELETE /communications/rfqs/{rfq_id}/quotes/{quote_id}) instead"
    )]
    ...
    #[deprecated(
        note = "use `accept_rfq_quote` (PUT /communications/rfqs/{rfq_id}/quotes/{quote_id}/accept) instead"
    )]
    ...
    #[deprecated(
        note = "use `confirm_rfq_quote` (PUT /communications/rfqs/{rfq_id}/quotes/{quote_id}/confirm) instead"
    )]
    ...
    /// Get a quote scoped to its RFQ. Replaces the deprecated quote-ID-only
    /// `get_quote` (deprecated 2026-07-09).
    ...
    /// Delete a quote scoped to its RFQ, which means it can no longer be
    /// accepted. Replaces the deprecated quote-ID-only `delete_quote`
    ...
    /// Accept a quote scoped to its RFQ. This will require the quoter to
    /// confirm. Replaces the deprecated quote-ID-only `accept_quote`
    /// (deprecated 2026-06-25).
    ...
    /// Confirm a quote scoped to its RFQ. This will start a timer for order
    /// execution. Replaces the deprecated quote-ID-only `confirm_quote`
    /// (deprecated 2026-06-25).
