...
pub struct GetQuotesParams {
    ...
    /// Restrict to quotes last updated at or after this Unix timestamp. Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Restrict to quotes last updated at or before this Unix timestamp. Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    /// Look up a quote by quote ID alone.
    #[deprecated(
        note = "quote-ID-only lookup is deprecated (2026-07-09); use get_rfq_quote(rfq_id, quote_id) instead"
    )]
    ...
    /// Look up a quote scoped to its RFQ. Returns `404` if the quote doesn't belong
    /// to `rfq_id`. Added 2026-07-09.
    ...
    /// Delete a quote by quote ID alone.
    #[deprecated(
        note = "quote-ID-only actions are deprecated (2026-06-25); use delete_rfq_quote(rfq_id, quote_id) instead"
    )]
    ...
    /// Accept a quote by quote ID alone.
    #[deprecated(
        note = "quote-ID-only actions are deprecated (2026-06-25); use accept_rfq_quote(rfq_id, quote_id, body) instead"
    )]
    ...
    /// Confirm a quote by quote ID alone.
    #[deprecated(
        note = "quote-ID-only actions are deprecated (2026-06-25); use confirm_rfq_quote(rfq_id, quote_id) instead"
    )]
