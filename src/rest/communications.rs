...
impl KalshiRestClient {
    ...
    #[deprecated(since = "0.7.0", note = "use get_rfq_quote(rfq_id, quote_id) instead")]
    ...
    #[deprecated(
        since = "0.7.0",
        note = "use delete_rfq_quote(rfq_id, quote_id) instead"
    )]
    ...
    #[deprecated(
        since = "0.7.0",
        note = "use accept_rfq_quote(rfq_id, quote_id, body) instead"
    )]
    ...
    #[deprecated(
        since = "0.7.0",
        note = "use confirm_rfq_quote(rfq_id, quote_id) instead"
    )]
    ...
    /// Get a quote scoped to its RFQ. Preferred over `get_quote`. Added 2026-06-25.
    ...
    /// Delete a quote scoped to its RFQ. Preferred over `delete_quote`. Added 2026-06-25.
    ...
    /// Accept a quote scoped to its RFQ. Preferred over `accept_quote`. Added 2026-06-25.
    ...
    /// Confirm a quote scoped to its RFQ. Preferred over `confirm_quote`. Added 2026-06-25.
