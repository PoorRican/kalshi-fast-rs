...
pub struct GetQuotesParams {
    ...
    /// Deprecated by Kalshi; the API no longer guarantees this filters correctly.
    #[deprecated(
        note = "Deprecated in the OpenAPI spec; no replacement filter for quote creator."
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quote_creator_user_id: Option<String>,
    /// Deprecated by Kalshi; the API no longer guarantees this filters correctly.
    #[deprecated(note = "Deprecated in the OpenAPI spec; no replacement filter for RFQ creator.")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rfq_creator_user_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// Added 2026 (distinct from `rfq_user_filter`, which filters by RFQ creator).
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    /// Deprecated 2026-06-25. Use [`Self::get_rfq_quote`], which scopes the
    /// lookup to its RFQ and avoids ambiguity when a quote ID is reused.
    ...
    /// Deprecated 2026-06-25. Use [`Self::delete_rfq_quote`].
    ...
    /// Deprecated 2026-06-25. Use [`Self::accept_rfq_quote`].
    ...
    /// Deprecated 2026-06-25. Use [`Self::confirm_rfq_quote`].
    ...
    /// belong to the given RFQ. Added 2026-06-25 (RFQ-scoped quote lookup).
