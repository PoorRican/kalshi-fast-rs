...
/// GET /communications/quotes query params.
///
/// `market_ticker` / `event_ticker` filters were removed upstream on
...
pub struct GetQuotesParams {
    ...
    /// Deprecated by Kalshi; filtering by quote creator user ID.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quote_creator_user_id: Option<String>,
    /// Filter for quotes created by the authenticated user. Pass `"self"`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user_filter: Option<String>,
    /// Deprecated by Kalshi; filtering by RFQ creator user ID.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rfq_creator_user_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    ///
    /// Deprecated by Kalshi (2026-07-09) in favor of [`Self::get_quote_for_rfq`],
    /// which scopes the lookup to a specific RFQ. Still supported.
    ...
    /// does not belong to `rfq_id`. Added 2026-07-09.
    pub async fn get_quote_for_rfq(
        &self,
        rfq_id: &str,
        quote_id: &str,
    ...
    ///
    /// Deprecated by Kalshi (2026-06-25) in favor of
    /// [`Self::delete_quote_for_rfq`]. Still supported.
    ...
    /// Delete a quote scoped to a specific RFQ. Added 2026-06-25.
    pub async fn delete_quote_for_rfq(
        &self,
        rfq_id: &str,
        quote_id: &str,
    ...
    ///
    /// Deprecated by Kalshi (2026-06-25) in favor of
    /// [`Self::accept_quote_for_rfq`]. Still supported.
    ...
    /// Accept a quote scoped to a specific RFQ. Added 2026-06-25.
    pub async fn accept_quote_for_rfq(
        &self,
        rfq_id: &str,
        quote_id: &str,
        body: AcceptQuoteRequest,
    ...
    ///
    /// Deprecated by Kalshi (2026-06-25) in favor of
    /// [`Self::confirm_quote_for_rfq`]. Still supported.
    ...
    /// Confirm a quote scoped to a specific RFQ. Added 2026-06-25.
    pub async fn confirm_quote_for_rfq(
        &self,
        rfq_id: &str,
        quote_id: &str,
    ) -> Result<EmptyResponse, KalshiError> {
