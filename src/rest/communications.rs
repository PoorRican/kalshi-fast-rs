...
impl KalshiRestClient {
    ...
    /// Look up a quote by ID alone. Deprecated 2026-07-09 in favor of
    /// [`Self::get_quote_for_rfq`], which additionally scopes the lookup to
    /// its RFQ.
    ...
    /// Delete a quote by ID alone. Deprecated 2026-06-25 in favor of
    /// [`Self::delete_quote_for_rfq`].
    ...
    /// Accept a quote by ID alone. Deprecated 2026-06-25 in favor of
    /// [`Self::accept_quote_for_rfq`].
    ...
    /// Confirm a quote by ID alone. Deprecated 2026-06-25 in favor of
    /// [`Self::confirm_quote_for_rfq`].
