...
impl KalshiRestClient {
    ...
    /// RFQ quotes are no longer guaranteed durably queryable except in
    /// post-acceptance states, so clients should track the RFQ ID alongside
    /// the quote ID. Added 2026-06-25.
    ///
    /// **Requires auth.**
