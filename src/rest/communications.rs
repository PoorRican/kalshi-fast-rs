...
impl KalshiRestClient {
    ...
    /// Get a quote by ID only. Deprecated 2026-07-07 in favor of
    /// [`get_rfq_quote`](Self::get_rfq_quote), which scopes the lookup to its RFQ.
    #[deprecated(
        since = "0.7.0",
        note = "use get_rfq_quote instead; the quote-ID-only lookup is deprecated"
    )]
    ...
    /// Get a quote scoped to its RFQ. Replaces [`get_quote`](Self::get_quote).
    /// Added 2026-07-07.
    ...
    /// Delete a quote by ID only. Deprecated in favor of
    /// [`delete_rfq_quote`](Self::delete_rfq_quote).
    #[deprecated(
        since = "0.7.0",
        note = "use delete_rfq_quote instead; the quote-ID-only endpoint is deprecated"
    )]
    ...
    /// Delete a quote scoped to its RFQ. Replaces [`delete_quote`](Self::delete_quote).
    ...
    /// Accept a quote by ID only. Deprecated in favor of
    /// [`accept_rfq_quote`](Self::accept_rfq_quote).
    #[deprecated(
        since = "0.7.0",
        note = "use accept_rfq_quote instead; the quote-ID-only endpoint is deprecated"
    )]
    ...
    /// Accept a quote scoped to its RFQ. Replaces [`accept_quote`](Self::accept_quote).
    ...
    /// Confirm a quote by ID only. Deprecated in favor of
    /// [`confirm_rfq_quote`](Self::confirm_rfq_quote).
    #[deprecated(
        since = "0.7.0",
        note = "use confirm_rfq_quote instead; the quote-ID-only endpoint is deprecated"
    )]
    ...
    /// Confirm a quote scoped to its RFQ. Replaces [`confirm_quote`](Self::confirm_quote).
