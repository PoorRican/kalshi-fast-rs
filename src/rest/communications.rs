...
impl KalshiRestClient {
    ...
    ///
    /// Deprecated 2026-06-25: use [`Self::get_rfq_quote`] instead, which
    /// scopes the lookup to its RFQ. Quotes are no longer guaranteed to
    /// remain durably queryable through this endpoint once cleared by a
    /// server roll or restart.
    #[deprecated(
        since = "0.7.0",
        note = "use get_rfq_quote instead; scope quote actions to their RFQ"
    )]
    ...
    /// Look up a quote scoped to its RFQ. Returns `404` if the quote does
    /// not belong to the given RFQ. Added 2026-06-25.
    ...
    #[deprecated(
        since = "0.7.0",
        note = "use delete_rfq_quote instead; scope quote actions to their RFQ"
    )]
    ...
    /// Cancel a quote scoped to its RFQ, so it can no longer be accepted.
    /// Added 2026-06-25.
    ...
    #[deprecated(
        since = "0.7.0",
        note = "use accept_rfq_quote instead; scope quote actions to their RFQ"
    )]
    ...
    #[deprecated(
        since = "0.7.0",
        note = "use confirm_rfq_quote instead; scope quote actions to their RFQ"
    )]
    ...
    /// Confirm a quote scoped to its RFQ. Starts a timer for order
