...
pub struct GetQuotesParams {
    ...
    /// Deprecated upstream; kept for FCM-only back-compat.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    ///
    /// Added 2026-06-25. Prefer over `delete_quote` for enhanced durability.
    ...
    ///
    /// Added 2026-06-25. Prefer over `accept_quote` for enhanced durability.
    ...
    ///
    /// Added 2026-06-25. Prefer over `confirm_quote` for enhanced durability.
