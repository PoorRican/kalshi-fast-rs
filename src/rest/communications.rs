...
pub struct Quote {
    ...
    /// Subaccount number of the quote creator, when the caller is the quote
    /// creator (2026-07-30).
    #[serde(default)]
    pub creator_subaccount: Option<u32>,
    /// Subaccount number of the RFQ creator, when the caller is the RFQ
    /// creator (2026-07-30).
    #[serde(default)]
...
pub struct RFQ {
    ...
    pub creator_user_id: Option<String>,
    /// Subaccount number of the RFQ creator, when the caller is the RFQ
    /// creator (2026-07-30 on the WS `communications` channel; mirrored here
    /// on the REST RFQ object).
    #[serde(default)]
    pub creator_subaccount: Option<u32>,
    #[serde(default)]
    pub cancelled_ts: Option<String>,
...
pub struct GetQuotesParams {
    ...
    /// Restrict to quotes last updated after this Unix timestamp (2026-06-18).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Restrict to quotes last updated before this Unix timestamp (2026-06-18).
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[deprecated(note = "spec marks this filter as deprecated; prefer user_filter")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quote_creator_user_id: Option<String>,
    #[deprecated(note = "spec marks this filter as deprecated; prefer rfq_user_filter")]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub rfq_creator_user_id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    #[deprecated(note = "upstream deprecated the quote-ID-only lookup; use get_rfq_quote")]
    ...
    #[deprecated(note = "upstream deprecated the quote-ID-only action; use delete_rfq_quote")]
    ...
    #[deprecated(note = "upstream deprecated the quote-ID-only action; use accept_rfq_quote")]
    ...
    #[deprecated(note = "upstream deprecated the quote-ID-only action; use confirm_rfq_quote")]
    ...
    /// Get a quote scoped to its RFQ. The quote must belong to `rfq_id`,
    /// otherwise the endpoint returns 404 (added 2026-06-25; prefer this over
    /// [`get_quote`](Self::get_quote), whose quote-ID-only lookup is
    /// deprecated).
    ...
    /// Delete a quote scoped to its RFQ (added 2026-06-25; prefer this over
    /// [`delete_quote`](Self::delete_quote), which is deprecated).
    ...
    /// Accept a quote scoped to its RFQ (added 2026-06-25; prefer this over
    /// [`accept_quote`](Self::accept_quote), which is deprecated).
    ...
    /// Confirm a quote scoped to its RFQ (added 2026-06-25; prefer this over
    /// [`confirm_quote`](Self::confirm_quote), which is deprecated).
