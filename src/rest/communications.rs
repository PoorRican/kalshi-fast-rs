...
pub struct GetQuotesParams {
    ...
    /// Restrict results to quotes last updated after this Unix timestamp. Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Restrict results to quotes last updated before this Unix timestamp. Added 2026-06-18.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    /// Get a quote scoped to its RFQ. Prefer this over [`Self::get_quote`],
    /// which Kalshi deprecated 2026-06-25.
    ...
    /// Delete a quote scoped to its RFQ. Prefer this over [`Self::delete_quote`],
    /// which Kalshi deprecated 2026-06-25.
    ...
    /// Accept a quote scoped to its RFQ. Prefer this over [`Self::accept_quote`],
    /// which Kalshi deprecated 2026-06-25.
    ...
    /// Confirm a quote scoped to its RFQ. Prefer this over [`Self::confirm_quote`],
    /// which Kalshi deprecated 2026-06-25.
    ...
    #[deprecated(note = "use get_rfq_quote instead; Kalshi deprecated this endpoint 2026-06-25")]
    ...
    #[deprecated(note = "use delete_rfq_quote instead; Kalshi deprecated this endpoint 2026-06-25")]
    ...
    #[deprecated(note = "use accept_rfq_quote instead; Kalshi deprecated this endpoint 2026-06-25")]
    ...
    #[deprecated(
        note = "use confirm_rfq_quote instead; Kalshi deprecated this endpoint 2026-06-25"
    )]
