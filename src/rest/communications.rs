...
pub struct Quote {
    ...
    /// Subaccount of the quote creator. Visible when the caller is the
    /// quote creator.
    #[serde(default)]
    pub creator_subaccount: Option<u32>,
    /// Subaccount of the RFQ creator. Visible when the caller is the RFQ
    /// creator.
    #[serde(default)]
...
pub struct GetQuotesParams {
    ...
    /// Deprecated upstream; prefer filtering by RFQ, status, or update time.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    /// Get a quote by ID.
    ///
    /// Deprecated upstream (2026-06-25); use [`Self::get_rfq_quote`] instead.
    ...
    ///
    /// Deprecated upstream (2026-06-25); use [`Self::delete_rfq_quote`] instead.
    ...
    ///
    /// Deprecated upstream (2026-06-25); use [`Self::accept_rfq_quote`] instead.
    ...
    ///
    /// Deprecated upstream (2026-06-25); use [`Self::confirm_rfq_quote`] instead.
    ...
    /// Get a quote scoped to its RFQ. Added 2026-06-25.
