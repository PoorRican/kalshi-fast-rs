...
pub struct GetQuotesParams {
    ...
    /// Restrict to quotes last updated after this Unix timestamp.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub min_ts: Option<i64>,
    /// Restrict to quotes last updated before this Unix timestamp.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// Deprecated by Kalshi; use `user_filter` instead.
    #[deprecated(
        since = "0.7.0",
        note = "Deprecated upstream. Use `user_filter` instead."
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub quote_creator_user_id: Option<String>,
    /// Deprecated by Kalshi; use `rfq_user_filter` instead.
    #[deprecated(
        since = "0.7.0",
    ...
    /// Removed server-side 2026-06-20; the exchange no longer filters by event ticker.
    /// Setting this field has no effect. Use time-range or status filters instead.
    #[deprecated(
        since = "0.7.0",
        note = "Kalshi removed event_ticker filtering on 2026-06-20. This field is ignored by the server."
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub event_ticker: Option<String>,
    /// Removed server-side 2026-06-20; the exchange no longer filters by market ticker.
    /// Setting this field has no effect. Use time-range or status filters instead.
    #[deprecated(
        since = "0.7.0",
        note = "Kalshi removed market_ticker filtering on 2026-06-20. This field is ignored by the server."
    )]
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    ///
    /// Prefer this over `delete_quote` when operating within an RFQ workflow.
    /// The RFQ-scoped path makes the intent explicit and avoids accidental
    /// cross-RFQ mutations.
    ///
    /// **Requires auth.**
    ...
    ///
    /// After acceptance the quoter must call `confirm_rfq_quote` to execute.
    ///
    /// **Requires auth.**
    ...
    ///
    /// Confirms acceptance and starts the execution timer.
    ///
    /// **Requires auth.**
