...
pub struct GetQuotesParams {
    ...
    /// Filter for quotes created by the authenticated user. Pass `"self"` to
    /// enable.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl KalshiRestClient {
    ...
    /// Deprecated 2026-06-25 in favor of [`Self::get_rfq_quote`] (RFQ-scoped
    /// lookup). Kept for now, but quotes are no longer guaranteed queryable
    /// by ID alone.
    ...
    /// Deprecated 2026-06-25 in favor of [`Self::delete_rfq_quote`] (RFQ-scoped).
    ...
    /// Deprecated 2026-06-25 in favor of [`Self::accept_rfq_quote`] (RFQ-scoped).
    ...
    /// Deprecated 2026-06-25 in favor of [`Self::confirm_rfq_quote`] (RFQ-scoped).
    ...
    /// does not belong to the given RFQ. Prefer this over [`Self::get_quote`]
    /// (deprecated 2026-06-25): quotes are no longer guaranteed queryable by
    /// ID alone once cleared during a server roll or restart.
    ...
    /// Delete a quote scoped to a specific RFQ. Prefer this over
    /// [`Self::delete_quote`] (deprecated 2026-06-25).
    ...
    /// Accept a quote scoped to a specific RFQ. Prefer this over
    /// [`Self::accept_quote`] (deprecated 2026-06-25).
    ...
    /// Confirm a quote scoped to a specific RFQ. Prefer this over
    /// [`Self::confirm_quote`] (deprecated 2026-06-25).
