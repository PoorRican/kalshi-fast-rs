...
//! This module exposes the CRUD endpoints.
//!
//! The ticker-pair lookup helper (`PUT .../lookup`) and the lookup history
//! feed (`GET .../lookup`) were removed from the OpenAPI spec on 2026-08-06;
...
pub struct MultivariateEventCollection {
    ...
    /// Identifier for the exchange shard this collection's markets live on. Added 2026-08-06.
    #[serde(default)]
