...
//! This module exposes the CRUD endpoints and the deprecated ticker-pair
//! lookup helper. The lookup-history feed (`GET .../lookup`) was fully
//! removed from the OpenAPI spec on 2026-07-02; use RFQs instead.
...
impl KalshiRestClient {
    ...
    /// Look up a market ticker for a given selected-market combination in a
    /// multivariate event collection.
    ///
    /// Deprecated: this endpoint predates RFQs and is marked `deprecated: true`
    /// in the OpenAPI spec. It is not removed and remains usable, but new
    /// integrations should use RFQs instead.
    #[deprecated(note = "predates RFQs; the OpenAPI spec marks this endpoint deprecated")]
