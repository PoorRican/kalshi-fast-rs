...
//! This module exposes the CRUD endpoints and the ticker-pair-based market
//! creation/resolution flow.
//!
//! The `PUT .../{collection_ticker}/lookup` endpoint (and its lookup-history
//! sibling) was removed upstream on 2026-08-06; this crate no longer models it.
//! Use `create_market_in_multivariate_event_collection` (`POST
//! .../{collection_ticker}`) to create or resolve a combo market, or the
