...
//! This module exposes the CRUD endpoints and the (deprecated upstream)
//! ticker-pair lookup helper. The lookup-history feed
//! (`GET .../lookup?lookback_seconds=`) was fully removed upstream
//! (2026-07-02) and has no replacement in the current OpenAPI spec.
...
impl KalshiRestClient {
    ...
    ///
    /// Deprecated upstream (`deprecated: true` in the OpenAPI spec as of
    /// 2026-07): this endpoint predates RFQs and should not be used for new
    /// integrations.
    #[deprecated(
        since = "0.7.0",
        note = "Predates RFQs; Kalshi's OpenAPI spec marks this deprecated. Do not use for new integrations."
    )]
