...
//! (`PUT .../lookup`) and its lookup-history counterpart (`GET .../lookup`)
//! were removed from the API on 2026-08-06; use `create_market_in_multivariate_event_collection`
//! or the communications (RFQ) APIs instead.
