...
//! This module exposes the CRUD endpoints. The `PUT .../lookup` ticker-pair
//! lookup endpoint and its lookup-history feed were removed by Kalshi on
//! 2026-08-06; use `POST /multivariate_event_collections/{collection_ticker}`
//! to create or resolve a combo market instead. See `docs/spec-parity.md`.
