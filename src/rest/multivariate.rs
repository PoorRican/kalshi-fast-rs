...
//! and the lookup-history feed were removed by Kalshi on 2026-08-06; use
//! `POST /multivariate_event_collections/{collection_ticker}` (creation) or
//! the communications (RFQ) APIs instead.
