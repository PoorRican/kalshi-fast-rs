...
//! lookup-history feed predated RFQs and were removed upstream 2026-08-06; use
//! the communications (RFQ) APIs or `POST .../{collection_ticker}` instead.
...
pub struct MultivariateEventCollection {
    ...
    /// Exchange shard this collection lives on. Added 2026-08-06.
    #[serde(default)]
