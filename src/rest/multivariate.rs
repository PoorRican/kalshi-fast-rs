...
//!
//! The lookup history feed (`GET .../lookup`) was fully deprecated and
//! removed from the OpenAPI spec (2026-07-02) and is no longer modeled here.
//! The ticker-pair lookup helper itself (`PUT .../lookup`) is now also marked
//! deprecated upstream in favor of RFQs; see [`KalshiRestClient::lookup_tickers_for_market_in_multivariate_event_collection`].
...
impl KalshiRestClient {
    ...
    ///
    /// Deprecated upstream (predates RFQs); do not use for new integrations.
