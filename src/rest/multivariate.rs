...
//! The lookup helper predates RFQs and is deprecated upstream; the lookup
//! *history* endpoint it used to pair with was removed from the OpenAPI spec
//! entirely (2026-07-02) and has no replacement.
...
impl KalshiRestClient {
    ...
    ///
    /// **Deprecated upstream** (predates RFQs; not recommended for new
    /// integrations). No replacement endpoint exists — RFQs are the
    /// recommended flow instead.
    #[deprecated(note = "predates RFQs and is deprecated upstream; use RFQs instead")]
