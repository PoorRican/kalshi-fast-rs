...
//! This module exposes the CRUD endpoints for listing collections and
//! creating markets within them via ticker-pair selections.
//!
//! Note: the `/lookup` endpoints (ticker-pair lookup and lookup history) were
//! deprecated 2026-07-02 and fully removed from the live API 2026-08-06; the
//! corresponding client methods and types have been removed accordingly.
