...
//! This module exposes the CRUD endpoints. The ticker-pair lookup and lookup-history
//! endpoints (`PUT .../lookup`, `GET .../lookup`) were removed by Kalshi 2026-08-06; use
//! `create_market_in_multivariate_event_collection` to create or resolve a combo market.
