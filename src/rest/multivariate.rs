...
//! This module exposes the CRUD endpoints and the market-creation helper.
//!
//! The lookup surface (`PUT .../lookup` and the lookup-history feed) was
//! deprecated 2026-07-02 and removed from the Predictions REST API on
//! 2026-08-06; it is no longer modeled here. Use
//! [`KalshiRestClient::create_market_in_multivariate_event_collection`],
//! which returns the resolved market ticker directly.
