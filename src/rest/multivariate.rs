...
//! This module exposes the CRUD endpoints and the ticker-pair lookup helpers.
//! The lookup history feed (`GET .../lookup` with `lookback_seconds`) was
//! removed from the OpenAPI spec by 2026-07-02 ("fully deprecated") and has
//! no replacement in this crate.
