...
//! This module exposes the CRUD endpoints. The legacy ticker-pair lookup
//! surface (`PUT .../lookup` and its history feed) predated RFQs and was
//! removed upstream 2026-08-06; use [`KalshiRestClient::create_market_in_multivariate_event_collection`]
//! or the communications (RFQ) APIs for quoting workflows instead.
