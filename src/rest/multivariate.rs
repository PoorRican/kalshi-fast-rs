...
//! This module exposes the CRUD endpoints. The ticker-pair lookup endpoint and
//! its lookup-history feed predated RFQs and were removed 2026-08-06; use
//! `create_market_in_multivariate_event_collection` or the communications
//! (RFQ) APIs instead.
...
use crate::types::{ExchangeIndex, YesNo, deserialize_null_as_empty_vec};
...
pub struct MultivariateEventCollection {
    ...
    /// Exchange shard this collection's markets live on. Added 2026-08-06
