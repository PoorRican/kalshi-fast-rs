...
//! (deprecated upstream in favor of RFQs). The lookup history feed was removed
//! from the OpenAPI spec (2026-07-02) and is no longer modeled here.
...
impl KalshiRestClient {
    ...
    ///
    /// DEPRECATED upstream: this endpoint predates RFQs and should not be used
    /// for new integrations. The OpenAPI spec marks it `deprecated: true`, but
    /// it remains present and functional.
    #[deprecated(
        since = "0.7.0",
        note = "predates RFQs; not recommended for new integrations by upstream Kalshi docs"
    )]
