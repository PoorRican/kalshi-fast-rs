...
//! (`PUT .../lookup`) and the lookup history feed (`GET .../lookup`) were removed
//! from the API 2026-07-02/2026-08-06; use `create_market_in_multivariate_event_collection`
//! to create or resolve a combo market instead.
