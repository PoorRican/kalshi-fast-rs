...
//! endpoint and lookup-history feed were removed upstream 2026-08-06; use
//! `create_market_in_multivariate_event_collection` or the RFQ/communications
//! APIs instead.
...
pub struct MultivariateEventCollection {
    ...
    /// Exchange shard this collection's markets live on. See `docs/spec-parity.md`.
    #[serde(default)]
