...
//! This module exposes the collection read endpoints and combo-market creation.
//!
//! The deprecated lookup surface
//! (`PUT`/`GET /multivariate_event_collections/{collection_ticker}/lookup`)
//! was removed upstream on 2026-08-06. Use
//! [`KalshiRestClient::create_market_in_multivariate_event_collection`] to
//! create or resolve a combo market, or the communications (RFQ) APIs for
//! quoting workflows.
...
pub struct MultivariateEventCollection {
    ...
    /// Exchange shard this collection's markets are created on.
    /// Added 2026-08-06.
    #[serde(default)]
