...
//! type used when creating a market in a collection.
//!
//! The `PUT .../lookup` and `GET .../lookup` (lookup history) endpoints were
//! removed by Kalshi on 2026-08-06; this predated RFQs and has no
//! replacement in this crate. Use `create_market_in_multivariate_event_collection`
//! or the communications (RFQ) APIs instead. See `docs/spec-parity.md`.
...
pub struct MultivariateEventCollection {
    ...
    /// Exchange index inherited from the collection's series. Added
    /// 2026-08-06.
    #[serde(default)]
