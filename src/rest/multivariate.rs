...
//! This module exposes the CRUD endpoints. The standalone ticker-pair lookup
//! endpoint (`PUT .../lookup`) and its lookup-history feed (`GET .../lookup`)
//! were removed from the Predictions REST API on 2026-08-06; use
//! [`KalshiRestClient::create_market_in_multivariate_event_collection`] or the
//! communications (RFQ) APIs for quoting workflows instead.
...
pub struct MultivariateEventCollection {
    ...
    /// Target exchange instance for this collection. Added 2026-08-06.
    #[serde(default)]
