...
/// A volume-based API usage-level goal. Earning `earn_volume_goal_fp` in
/// trailing 30-day volume qualifies for `level`; falling below
/// `keep_volume_goal_fp` risks losing it. Added 2026-06-11.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
impl KalshiRestClient {
    ...
    /// Advanced API usage-level grant on the Predictions exchange instance;
    /// requires at least 1 of the user's last 100 Predictions orders to have
    /// been created via API. Added 2026-06-11.
    ///
    /// **Requires auth.**
