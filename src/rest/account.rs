...
/// A single volume-based API usage tier goal. Added 2026-06-11.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
pub struct ApiKey {
    ...
    /// only read/trade on it. Absent/null means the key is unrestricted.
    /// Added 2026-07-02.
    #[serde(default)]
...
impl KalshiRestClient {
    ...
    /// Get the authenticated user's trailing 30d trading volume and progress
    /// toward volume-based API usage tiers (Predictions lane). Added 2026-06-11.
    ///
    /// **Requires auth.**
