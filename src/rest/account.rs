...
/// Latest cron-computed trading volume progress. Added 2026-06-11.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
pub struct ApiKey {
    ...
    /// Subaccount (0-63) this key is restricted to, if any. Absent when the
...
impl KalshiRestClient {
    ...
    /// Get trailing 30d volume and per-tier earn/keep goals for volume-based
