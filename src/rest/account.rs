...
pub struct SubaccountBalance {
    ...
    pub updated_ts: i64,
    /// Exchange index this balance applies to. A subaccount with funds on
    /// multiple exchange indexes reports one entry per index. Added 2026-07-02.
    #[serde(default)]
    pub exchange_index: Option<crate::rest::exchange::ExchangeIndex>,
}
...
impl KalshiRestClient {
    ...
    /// API usage tiers for the Predictions lane. Added 2026-06-11.
    ///
    /// **Requires auth.**
    ...
    /// Self-promote to the Advanced API usage tier. Requires that at least one
    /// of the account's last 100 Predictions orders was created via API.
    /// Added 2026-06-11.
    ///
    /// **Requires auth.**
