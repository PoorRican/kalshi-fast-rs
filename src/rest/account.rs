...
/// Latest cron-computed trading volume progress for the predictions
/// (event_contract) lane. Added 2026-06-11.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
/// Response for `GET /account/api_usage_level/volume_progress`. Added
/// 2026-06-11.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
pub struct SubaccountBalance {
    ...
    pub updated_ts: i64,
    /// Exchange index this balance is scoped to. A subaccount with funds on
...
pub struct ApiKey {
    ...
    /// The subaccount this key is restricted to (0-63), absent when the key
    /// is unrestricted. Added 2026-07-02.
    #[serde(default)]
...
pub struct GetApiKeysResponse {
    ...
    /// lapsed. Absent when the account has never attested. Added
    /// 2026-08-16.
    #[serde(default)]
...
pub struct CreateApiKeyRequest {
    ...
    pub scopes: Vec<String>,
    /// Restrict the key to a single subaccount (0-63). Omit to create an
...
impl KalshiRestClient {
    ...
    /// Get the account's trailing 30-day volume progress toward volume-based
    /// API usage tiers for the predictions (event_contract) lane. Added
    /// 2026-06-11.
    ///
    /// **Requires auth.**
    ...
    /// Grant a permanent Advanced API usage-level grant for the predictions
    /// (event_contract) exchange instance. Requires at least 1 of the last
    /// 100 Predictions orders to have been created via API. Added
    /// 2026-06-11.
    ///
    /// **Requires auth.**
