...
/// A Predictions volume-based tier goal, part of [`AccountApiUsageLevelVolumeProgress`].
#[derive(Debug, Clone, Deserialize, Serialize)]
...
/// usage tiers for the predictions (event_contract) lane. Added 2026-06-11.
#[derive(Debug, Clone, Deserialize, Serialize)]
...
pub struct ApiKey {
    ...
    /// If set, this key is restricted to a single subaccount (0-63) and may
    /// only read and trade on it. Absent/null means the key is unrestricted.
    /// Added 2026-07-02.
    #[serde(default)]
...
pub struct CreateApiKeyRequest {
    ...
    pub scopes: Vec<String>,
    /// Restrict the key to a single subaccount (0-63) you own. Omit to leave
...
impl KalshiRestClient {
    ...
    /// Self-promote to the Advanced API usage tier. Requires at least 1 of
